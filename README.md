# Flip A Coin Game using Nillion Blind Computation

# Start

This is a demo of the Flip a Coin Game using Nillion's Blind Computation
...
```
git clone https://github.com/pranav2564/Flip-a-Coin-Nillion.git
cd cra-nillion
```
